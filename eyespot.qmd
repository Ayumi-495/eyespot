...
Custom function is used for calculating effect sizes (lnRR) and their variance from raw data.
...
```
Table 2 - Heterogeneity of effect size
...
```
Table 10. Model goodness-of-fit
