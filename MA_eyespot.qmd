...
knitr::kable(t_r2_1)  
```
**Table XX. Heterogeneity of effect size and model goodness-of-fit**
...
i2_2 <- round(i2_ml(mr_diameter), 4)
...
i2_5 <- round(i2_ml(mr_prey_type), 4)
...
i2_6 <- round(i2_ml(mr_prey_shape), 4)
...
```
![Figure - discrete moderators](figs/fig1.png)
...
```
![Figure - continuous moderators](figs/fig2.png)
