...
```
It seems **pattern total area** is a slightly better predictor than **diameter**?.
...
Only include moderators related to conspicuousness (pattern area/total pattern area and number of patterns) in the model.
...
comb_p <- orchard_plot(comb,
                    group = "Study_ID",
                    xlab = "log response ratio (lnRR)",
                    tree.order = c( "Artificial", "Real","Conspicuous","Eyespot", "Intrcpt"),
                    angle = 45,
                    branch.size = 2) +
...
comb_p
# ggsave("fig2_ver2.pdf", width = 15, height = 7, dpi = 450)
...
# total pattern area
p7 <- bubble_plot(mr_area_T,
            mod = "Log_area_pattern_T",
            group = "Study_ID",
            xlab = "Log-transformed total pattern area")

# diameter
p8 <- bubble_plot(mr_diameter,
            mod = "Log_diameter",
            group = "Study_ID",
            xlab = "Log-transformed diameter")

# background
p9 <- bubble_plot(mr_background,
            mod = "Log_background",
            group = "Study_ID",
...
# ggsave("figS3.pdf", width = 10, height = 10, dpi = 450)
```
